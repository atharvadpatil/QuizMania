    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>QuizMania</b></a>
            </div>
                    ...
                    if(@$_GET['q']==4 && !(@$_GET['step']) ) 
                    {
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 control-label" for="link"></label>  
                                    <div class="col-md-12">
                                        <input id="link" name="link" placeholder="Provide preparation link" class="form-control input-md" type="text">
                                    </div>
                                </div>
